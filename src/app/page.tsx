    ...
    <div className="min-h-screen bg-white">
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-slate-200 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="text-xl font-bold text-blue-600">TysonsTechSolutions</div>
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/login" className="text-slate-600 hover:text-blue-600">Log In</Link>
          </div>
          <Link href="/signup" className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-medium">Start Free Trial</Link>
        </div>
      </nav>
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-6">AI-Powered Lead Generation</div>
          <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6">AI-Powered Tools for<br /><span className="text-blue-600">Service Contractors</span></h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-medium text-lg shadow-lg">Start Free 14-Day Trial</Link>
            <Link href="#demo" className="border-2 border-slate-300 hover:border-blue-600 text-slate-700 px-8 py-4 rounded-lg font-medium text-lg">See It In Action</Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="bg-slate-800 rounded-xl p-6">
              <p className="text-blue-400 font-semibold mb-2">The Solution:</p>
          ...
          <div className="bg-slate-800 rounded-2xl p-8 space-y-6">
            <div className="flex items-center gap-4"><div className="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center text-2xl">⚡</div><div><div className="text-2xl font-bold">2 seconds</div><div className="text-slate-400">Average response time</div></div></div>
      ...
      <section id="pricing" className="py-20 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="rounded-2xl p-8 bg-white border border-slate-200"><div className="text-xl font-semibold mb-2">Starter</div><div className="mb-6"><span className="text-4xl font-bold">$99</span>/mo</div><ul className="space-y-2 text-slate-600 mb-8"><li>500 conversations/mo</li><li>50 leads/month</li></ul><Link href="/signup" className="block w-full py-3 rounded-lg font-medium text-center bg-blue-600 text-white">Start Trial</Link></div>
            <div className="rounded-2xl p-8 bg-blue-600 text-white ring-4 ring-blue-600 ring-offset-2"><div className="text-sm text-blue-200 mb-2">RECOMMENDED</div><div className="text-xl font-semibold mb-2">Growth</div><div className="mb-6"><span className="text-4xl font-bold">$249</span>/mo</div><ul className="space-y-2 text-blue-100 mb-8"><li>2,000 conversations/mo</li><li>200 leads/month</li><li>SMS notifications</li></ul><Link href="/signup" className="block w-full py-3 rounded-lg font-medium text-center bg-white text-blue-600">Start Trial</Link></div>
            <div className="rounded-2xl p-8 bg-white border border-slate-200"><div className="text-xl font-semibold mb-2">Pro</div><div className="mb-6"><span className="text-4xl font-bold">$499</span>/mo</div><ul className="space-y-2 text-slate-600 mb-8"><li>Unlimited conversations</li><li>500 leads/month</li></ul><Link href="/signup" className="block w-full py-3 rounded-lg font-medium text-center bg-blue-600 text-white">Start Trial</Link></div>
          </div>
        </div>
      </section>
      <section className="py-20 px-6 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/signup" className="inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-medium text-lg">Get Started Free</Link>
        </div>
      </section>
